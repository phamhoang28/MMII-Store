    ...
    <div class="offcanvas_menu_wrapper">
        ...
        <div class="search_bar">
            <form action="product?action=search" method="POST">
                <li><a href="product?action=listByCategory&category_id=${c.category_id}"></a></li>
        ...
        <div class="cart_area">
            <div class="cart_link">
                <a href="cart?action=cart"><i class="fa fa-shopping-basket">${sessionScope.size}</i>Giỏ Hàng</a>
            </div>
        </div>
        ...
        <div class="offcanvas_footer">
            <span><a href="#"><i class="fa fa-envelope-o"></i> phamhoang0228@gmail.com</a></span>
            <ul>
            ...
            <div class="middel_inner">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="logo" 
                             >
                            <a href="home"><img src="assets/img/logo/logo.png" width="65px" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="cart_area">
