                        ...
                        <div class="product_d_right">
                            <form action="cart?product_id=${ProductData.product_id}" method="POST">
                                ...
                                <div class="product_variant color">
                                    <h3>sex</h3>
                                    <select class="niceselect_option" id="color" name="sex">
                                        <c:forEach items="${SexData}" var="c">
                                            <option value="${c.sex}">${c.sex}</option>
                                        </c:forEach>
                                    </select>   
                                </div>
                                ...
                                <div class="product_variant quantity">
                                    ...
                                    <button class="button" onclick="buy('${ProductData.product_id}')" >Thêm vào giở hàng</button>  
                                </div>
                            </form>
                        </div>
                    </div>
