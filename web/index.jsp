                                ...
                                <div class="col-lg-3">
                                    <div class="single_product">
                                        <div class="product_thumb">
                                            <a class="primary_img" href="productdetail?action=productdetail&product_id=${top10.product_id}"><img src="${top10.img}" width="10px;" alt=""></a>
                                            <div class="quick_button">
                                                <a href="productdetail?action=productdetail&product_id=${top10.product_id}" title="quick_view">Xem sản phẩm</a>
                                            </div>
                                        </div>
                                        <div class="product_content">
                                            <h3><a href="productdetail?action=productdetail&product_id=${top10.product_id}">${top10.product_name}</a></h3>
                        ...
                        <div class="banner_area">
                            <div class="banner_thumb">
                                ...
                                <div class="banner_content">
                                    <h1>Perfurm <br> Men’s Collection</h1>
                                    <a href="product">Discover Now</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="banner_area">
                            <div class="banner_thumb">
                                ...
                                <div class="banner_content">
                                    <h1>Perfurm <br> Women’s Collection</h1>
                                    <a href="product">Discover Now</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="product_carousel product_three_column4 owl-carousel">
                            ...
                            <div class="col-lg-3">
                                    <div class="single_product">
                                        <div class="product_thumb">
                                            <a class="primary_img" href="productdetail?action=productdetail&product_id=${td.product_id}"><img src="${td.img}" width="10px;" alt=""></a>
                                            <div class="quick_button">
                                                <a href="productdetail?action=productdetail&product_id=${td.product_id}" title="quick_view">Xem sản phẩm</a>
                                            </div>
                                        </div>
                                        <div class="product_content">
                                            <h3><a href="productdetail?action=productdetail&product_id=${td.product_id}">${td.product_name}</a></h3>
